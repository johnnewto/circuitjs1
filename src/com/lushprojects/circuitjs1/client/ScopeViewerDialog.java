...
public class ScopeViewerDialog extends DialogBox {
    ...
    String generatePlotlyHTML(String jsonData) {
        ...
        html.append("        // Use interpolated midpoint values if available, otherwise fall back to maxValues\n");
        html.append("        const yValues = plot.values && plot.values.length > 0 ? plot.values : plot.maxValues;\n");
        html.append("        \n");
        html.append("        traces.push({\n");
        html.append("          x: plot.time,\n");
        html.append("          y: yValues,\n");
