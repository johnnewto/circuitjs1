package com.lushprojects.circuitjs1.client.electronics.electromechanical;

import com.lushprojects.circuitjs1.client.*;
import com.lushprojects.circuitjs1.client.electronics.analog.CCCSElm;
...
//        setPin(3, x0, y0, 1, 0, 0,  1, 0, ys-cspc2);
        ...
        int dx = isFlippedX() ? -1 : 1;
        diode.setElementPosition(posts[0].x+32*dx, posts[0].y, posts[1].x+32*dx, posts[1].y);
        stubs[0] = diode.getElementPost(0);
        stubs[1] = diode.getElementPost(1);
        
        int midp = (posts[2].y+posts[3].y)/2;
	transistor.setFlipped(isFlippedY());
        transistor.setElementPosition(posts[2].x-40*dx, midp, posts[2].x-24*dx, midp);
        stubs[2] = transistor.getElementPost(1);
