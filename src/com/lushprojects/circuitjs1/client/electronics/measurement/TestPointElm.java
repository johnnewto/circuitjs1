package com.lushprojects.circuitjs1.client.electronics.measurement;
    ...
    protected void getInfo(String arr[]) {
        ...
        switch (meter) {
            ...
            case TP_FRQ:
                ...
                break;
            case TP_PER:
                arr[1] = "Period = " + getUnitText(period*sim.getMaxTimeStep()/sim.getIterCountForExport(), "S");
                break;
            case TP_PWI:
                arr[1] = "Pulse width = " + getUnitText(pulseWidth*sim.getMaxTimeStep()*sim.getIterCountForExport(), "S");
                break;
            case TP_DUT:
