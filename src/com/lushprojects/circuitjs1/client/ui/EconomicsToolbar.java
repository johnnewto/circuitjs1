...
public class EconomicsToolbar extends Toolbar {
    ...
    private String makeSvg(String s, int size) {
    ...
    private final String wireIcon = "<svg><g transform='scale(0.208) translate(7.5, 32)'>" +
    ...
    private final String multiplyIcon = "<svg><rect x='3' y='3' width='18' height='18' rx='2' fill='none' stroke='currentColor' stroke-width='2' /><text x='12' y='14.5' fill='blue' font-size='14' font-weight='bold' text-anchor='middle' dominant-baseline='middle'>×</text></svg>";
    
    private final String multiplyConstIcon = "<svg><rect x='3' y='3' width='18' height='18' rx='2' fill='none' stroke='currentColor' stroke-width='2' /><text x='12' y='14.5' fill='blue' font-size='11' font-weight='bold' text-anchor='middle' dominant-baseline='middle'>×K</text></svg>";
    
    private final String dividerIcon = "<svg><rect x='3' y='3' width='18' height='18' rx='2' fill='none' stroke='currentColor' stroke-width='2' /><text x='12' y='14.5' fill='blue' font-size='14' font-weight='bold' text-anchor='middle' dominant-baseline='middle'>÷</text></svg>";
    
    private final String divideConstIcon = "<svg><rect x='3' y='3' width='18' height='18' rx='2' fill='none' stroke='currentColor' stroke-width='2' /><text x='12' y='14.5' fill='blue' font-size='11' font-weight='bold' text-anchor='middle' dominant-baseline='middle'>÷K</text></svg>";
    
    private final String differentiatorIcon = "<svg><rect x='3' y='3' width='18' height='18' rx='2' fill='none' stroke='currentColor' stroke-width='2' /><text x='12' y='14.5' fill='blue' font-size='9' font-weight='bold' text-anchor='middle' dominant-baseline='middle' font-style='italic'>d/dt</text></svg>";
    
    private final String integratorIcon = "<svg><rect x='3' y='3' width='18' height='18' rx='2' fill='none' stroke='currentColor' stroke-width='2' /><text x='12' y='14.5' fill='blue' font-size='14' font-weight='bold' text-anchor='middle' dominant-baseline='middle'>∫</text></svg>";
    
    private final String odeIcon = "<svg><rect x='3' y='3' width='18' height='18' rx='2' fill='none' stroke='currentColor' stroke-width='2' /><text x='12' y='14.5' fill='blue' font-size='8' font-weight='bold' text-anchor='middle' dominant-baseline='middle'>ODE</text></svg>";
    
    private final String equationIcon = "<svg><rect x='3' y='3' width='18' height='18' rx='2' fill='none' stroke='currentColor' stroke-width='2' /><text x='12' y='14.5' fill='blue' font-size='14' font-weight='bold' text-anchor='middle' dominant-baseline='middle'>=</text></svg>";
    
    private final String percentIcon = "<svg><rect x='3' y='3' width='18' height='18' rx='2' fill='none' stroke='currentColor' stroke-width='2' /><text x='12' y='14.5' fill='blue' font-size='14' font-weight='bold' text-anchor='middle' dominant-baseline='middle'>%</text></svg>";
    
    private final String adderIcon = "<svg><rect x='3' y='3' width='18' height='18' rx='2' fill='none' stroke='currentColor' stroke-width='2' /><text x='12' y='14.5' fill='blue' font-size='16' font-weight='bold' text-anchor='middle' dominant-baseline='middle'>+</text></svg>";
    
    private final String subtracterIcon = "<svg><rect x='3' y='3' width='18' height='18' rx='2' fill='none' stroke='currentColor' stroke-width='2' /><text x='12' y='14.5' fill='blue' font-size='16' font-weight='bold' text-anchor='middle' dominant-baseline='middle'>−</text></svg>";
    
    private final String stopTimeIcon = "<svg><g transform='scale(1.3) translate(-3, 0)'><polygon points='12,3 17.5,5.5 20,11 17.5,16.5 12,19 6.5,16.5 4,11 6.5,5.5' fill='red' stroke='white' stroke-width='2' /><text x='12' y='11.5' fill='white' font-size='5' font-weight='bold' text-anchor='middle' dominant-baseline='middle'>STOP</text></g></svg>";
    ...
    private final String viewportIcon = "<svg><rect x='4' y='4' width='16' height='16' fill='none' stroke='#4080FF' stroke-width='2' stroke-dasharray='4,2' /><rect x='7' y='7' width='10' height='10' fill='none' stroke='#4080FF' stroke-width='1' /><line x1='4' y1='4' x2='20' y2='20' stroke='#4080FF' stroke-width='1' /></svg>";
    
    private final String graphIcon = "<svg><g transform='scale(0.99)'><rect x='4' y='4' width='16' height='16' fill='none' stroke='currentColor' stroke-width='2' /><polyline points='6,16 9,12 12,14 15,8 18,10' fill='none' stroke='currentColor' stroke-width='1.5' /></g></svg>";
        
    private final String labelNodeIcon = "<svg><g transform='scale(0.99)'><rect x='4' y='8' width='16' height='12' rx='2' fill='none' stroke='currentColor' stroke-width='2' /><text x='12' y='15.5' fill='currentColor' font-size='8' text-anchor='middle' dominant-baseline='middle'>L</text></g></svg>";
