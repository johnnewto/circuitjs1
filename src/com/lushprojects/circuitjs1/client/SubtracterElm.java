...
class SubtracterElm extends CircuitElm {
    int inputCount;
    ...
    void setPoints() {
        ...
        // Calculate input positions - input 0 (minuend) at top, input 1+ (subtrahends) below
    ...
    void stamp() {
        ...
        // Vout = V0 - V1 - V2 - ...
        // Same voltage source as AdderElm
        sim.stampVoltageSource(nodes[inputCount], 0, voltSource);
        
        // First input contributes +V0
        sim.stampVCVS(nodes[0], 0, 1.0, voltSource);
        
        // Other inputs contribute -Vi (swap nodes to negate)
        for (int i = 1; i < inputCount; i++) {
            sim.stampVCVS(0, nodes[i], 1.0, voltSource);
        }
    }
