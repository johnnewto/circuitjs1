...
public class TableElm extends ChipElm implements TableContentView {
     ...
     */
    public void updateRowData(int newRowCount, String[] newRowDescriptions, 
     ...
     */
    public boolean isCollapseArrowClicked(int gx, int gy) {
     ...
     */
    public void toggleCollapsedMode() {
    ...
    @Override
    protected boolean isDigitalChip() { return false; } // Analog chip with voltage outputs

    @Override
    protected String getChipName() { return "Table"; }
    ...
    public void openTableEditDialog() {
