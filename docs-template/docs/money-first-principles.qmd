...
subtitle: "Understanding Banking Models and Government Deficits"
author: "Based on Steve Keen's analysis for engineers"
---
...
These equations can be implemented in CircuitJS using economic elements (Godly Tables, Flow Masters, Stock Masters).
